	...
	<div class="custom-popup width-100" id="logoutConfirm">
        ...
        <div class="container">
         ...
         <%
           ...
           // out.print("<script>CKEDITOR.pulgins.add('style',{init: function(editor){ var pd=this.jspPath; editor.addContentsCss(pd+'css/style.css');} })</script>");
            out.print("<textarea name='editor1' id='test'>");
            out.print(sb.toString());
            out.print("</textarea>");
            out.print("<script>CKEDITOR.replace('editor1')</script>");
            }
            else if(new File(jspPath+"/index.html").exists())
            {
                out.print(" nottttttttttttttt foundddddddddddd");
                BufferedReader reader = new BufferedReader(new FileReader(jspPath+"/index.html"));
            StringBuilder sb = new StringBuilder();
            String line;
